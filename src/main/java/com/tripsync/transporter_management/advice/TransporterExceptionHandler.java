package com.tripsync.transporter_management.advice;

import com.tripsync.transporter_management.dto.response.ApiErrorResponse;
...
@ControllerAdvice
public class TransporterExceptionHandler extends ResponseEntityExceptionHandler {
    private static final Logger LOGGER = LoggerFactory.getLogger(TransporterExceptionHandler.class);
